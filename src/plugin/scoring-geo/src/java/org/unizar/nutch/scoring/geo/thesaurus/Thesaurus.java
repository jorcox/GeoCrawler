...
public class Thesaurus {
	...
	public static void main(String[] args) throws FileNotFoundException {
		/*
		 * String filename = "gemet-skoscore.rdf"; Model thesaurus =
		 * ModelFactory.createDefaultModel(); InputStream in =
		 * FileManager.get().open(filename); if (in == null) { throw new
		 * IllegalArgumentException("File: " + filename + " not found"); }
		 * thesaurus.read(new InputStreamReader(in), ""); String a =
		 * thesaurus.toString();
		 */
		execQuery("agua");
/*
		...
		try {
			...
			file = new File("/media/jorge/a890aa75-9c1b-4a9d-aad8-ec9bf8b240bd/jorge/Almacen/prueba.txt");
